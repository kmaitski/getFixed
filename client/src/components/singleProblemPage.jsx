...
class SingleProblemPage extends React.Component {
  ...
  componentWillMount() {
    axios
      .get(`/listing/${this.props.match.params.id}`)
      .then(response => {
        this.setState({
        ...
        <div className="container" style={{ position: 'center' }}>
          <Card>
            ...
            <CardTitle
              ...
              subtitle={this.state.currentProblem.description}
            />
            <CardText>Share this Listing.</CardText>
            <CardActions>
          ...
          <div
            ...
            style={{ padding: ' 0px 20px 80px 10px' }}
          >
            <Link to="/landing">
              <button
